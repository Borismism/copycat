...
daily_budget_eur        = "0.25"          # €0.25 for dev testing (~16 videos/day)
max_concurrent_videos   = 2               # Process 2 videos at a time
max_videos_to_scan      = 20              # Budget-aware scaling caps this further
